...
public class LibroActivity extends AppCompatActivity {
        ...
        call.enqueue(new Callback<Libro>() {
            ...
            public void onResponse(Call<Libro> call, Response<Libro> response) {
                if(response.isSuccessful()){
                    Toast.makeText(LibroActivity.this,"Se Elimino correctamente",Toast.LENGTH_LONG).show();
                }
            }
            @Override
    ...
    public void updateLibro(Libro p,int id){
        ...
        call.enqueue(new Callback<Libro>() {
            ...
            public void onResponse(Call<Libro> call, Response<Libro> response) {
                if(response.isSuccessful()){
                    Toast.makeText(LibroActivity.this,"Se Actualizó",Toast.LENGTH_LONG).show();
                }
            }
            @Override
            public void onFailure(Call<Libro> call, Throwable t) {
    ...
    public void addLibro(Libro p){
        ...
        call.enqueue(new Callback<Libro>() {
            ...
            public void onResponse(Call<Libro> call, Response<Libro> response) {
                if(response.isSuccessful()){
                    Toast.makeText(LibroActivity.this,"Se agregó",Toast.LENGTH_LONG).show();
                }
            }
            @Override
            public void onFailure(Call<Libro> call, Throwable t) {
